-- ============================================================
-- ASCENDX AI — Script completo para Neon PostgreSQL
-- ============================================================
-- INSTRUCCIONES:
-- 1. Crea un proyecto en https://neon.tech
-- 2. Copia la Connection String (postgresql://...)
-- 3. Opción A (recomendada): en backend/.env pon DATABASE_URL y ejecuta:
--      npx prisma migrate deploy
--      npm run db:seed
-- 3. Opción B: pega TODO este archivo en el SQL Editor de Neon
-- 4. Envíame la DATABASE_URL para conectar el backend
-- ============================================================
...
CREATE TABLE "Task" (
    ...
    CONSTRAINT "Task_goalId_fkey" FOREIGN KEY ("goalId") REFERENCES "Goal"("id") ON DELETE SET NULL,
...
CREATE TABLE "Habit" (
    ...
    CONSTRAINT "Habit_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE,
...
CREATE TABLE "FinanceRecord" (
    ...
    CONSTRAINT "FinanceRecord_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE,
