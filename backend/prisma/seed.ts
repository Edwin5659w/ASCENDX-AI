...
async function main() {
  ...
  await prisma.badge.createMany({
    data: [
      ...
      { id: 'STREAK_30', title: 'Imparable', subtitle: 'Racha de 30 días', sortOrder: 3 },
      { id: 'GOALS_3', title: 'Visionario', subtitle: '3 o más objetivos creados', sortOrder: 4 },
      { id: 'TASKS_10', title: 'Productivo', subtitle: '10 tareas completadas', sortOrder: 5 },
      { id: 'LEVEL_5', title: 'Ascenso', subtitle: 'Alcanza el nivel 5', sortOrder: 6 },
      { id: 'LEVEL_10', title: 'Maestro', subtitle: 'Alcanza el nivel 10', sortOrder: 7 },
      { id: 'STEEL', title: 'Acero', subtitle: '3 hábitos y racha 3+', sortOrder: 8 },
      { id: 'XP_500', title: 'Veterano', subtitle: '500 XP totales', sortOrder: 9 },
      { id: 'XP_1000', title: 'Leyenda', subtitle: '1000 XP totales', sortOrder: 10 },
      { id: 'FINANCE_START', title: 'Finanzas en orden', subtitle: '5 movimientos registrados', sortOrder: 11 },
      { id: 'REFERRER', title: 'Embajador', subtitle: 'Invitaste a alguien', sortOrder: 12 },
    ],
    skipDuplicates: true,
  });
