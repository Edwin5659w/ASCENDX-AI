...
function createStyles(theme: AppTheme) {
  return {
    ...
    logoWrap: { alignItems: 'center' as const, marginBottom: 20 },
    title: {
    ...
    focusBody: { flex: 1 },
    focusTitle: { color: theme.colors.text, fontSize: 16, fontWeight: '700' as const },
    focusDesc: { color: theme.colors.textMuted, fontSize: 12, marginTop: 2, lineHeight: 17 },
    focusMeta: { fontSize: 11, fontWeight: '600' as const, marginTop: 6 },
    setupBadge: {
      flexDirection: 'row' as const,
      alignItems: 'center' as const,
      gap: 8,
    ...
    setupBadgeText: { fontSize: 13, fontWeight: '600' as const },
    label: {
      color: theme.colors.text,
      fontSize: 13,
      fontWeight: '600' as const,
    ...
    chipTextActive: { color: theme.colors.accent, fontWeight: '600' as const },
    button: {
    ...
    skip: { marginTop: 16, alignItems: 'center' as const, paddingVertical: 8 },
    skipText: { color: theme.colors.textMuted, fontSize: 14 },
    back: { marginTop: 16, alignItems: 'center' as const, paddingVertical: 8 },
    backText: { color: theme.colors.primaryLight, fontSize: 14, fontWeight: '500' as const },
  };
}
