...
function createStyles(theme: AppTheme) {
  return {
    ...
    headerLeft: { flexDirection: 'row' as const, gap: 10, flex: 1 },
    headerText: { flex: 1 },
    ...
    xpBlock: { alignItems: 'flex-end' as const },
    xpValue: { color: theme.colors.primaryLight, fontSize: 24, fontWeight: '700' as const },
    ...
    xpFill: { height: '100%' as const, borderRadius: 5 },
    badgesTitle: {
    ...
    badgeTitle: { color: theme.colors.text, fontSize: 14, fontWeight: '600' as const, marginTop: 4 },
